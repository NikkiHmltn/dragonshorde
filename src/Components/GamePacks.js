...
function GamePacks() {
    return(
        ...
        <div className="information">
            <p>At The Dragon's Hoard, we love cards. We love them so much, we decided to bring them to the Lake Tahoe area for everyone else to enjoy too! Yugioh, Magic the Gathering, and Pokemon are our big sellers. Come check out all of our boosters, tins, singles, and sleeves. We want to make sure you have everything you need to enjoy your card collection or playing with friends (or with us!), so we have also stocked up on deck supplies to keep your cards safe from life. </p> 
            <br></br>
        ...
        <div className="store-policy">
                    <h3>Store Policy</h3>
                    <p>All sales and trades are final. Trades between players are generally permitted (cards only, no cash trades), but employees reserve all rights to disallow player to player trade for any reason.</p>
                </div>
        <Footer />
        </>
    )
